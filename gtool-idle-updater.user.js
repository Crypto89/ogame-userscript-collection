...
$(document).on('overview', function (event) {
    ...
    $("ul#menuTableTools").append(
      '<li id="menu-giu">'+
        '<span class="menu_icon"><div class="menuImage galaxy"></div></span>'+
        '<a href="javascript:localStorage.setItem(\'gtiu-update\', 1);document.location.href=\'index.php?page=galaxy\'" class="menubutton">'+
          '<span class="textLabel" style="color: #ff9600;">GIU: '+r_timeout+'</span>'+
        '</a>'+
      '</li>'
    );
